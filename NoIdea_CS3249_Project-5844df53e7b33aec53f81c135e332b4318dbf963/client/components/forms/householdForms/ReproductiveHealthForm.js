...
/**
 * @class ReproductiveHealthForm
 * @classdesc Step 6 - Household UI forms
 * 
 * Shows if(eligibleStudy)
 * 
 * Sets questionnaire #1
 * @memberof form
 * @todo implement solutions for the 'if no skip to {..}' and 'other (specify ...)' sections
 */
class ReproductiveHealthForm extends React.Component {
  constructor() {
    super();
    this.dispatch = null;
  }
