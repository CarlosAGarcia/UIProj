...
import EditButton from '../../containers/PathoUI/EditBiopsyResult';
...
/**
 * Component for Biopsy pathologist table
 */
class BiopsyPatho extends Component {
  render() {
 ...
 */
BiopsyPatho.propTypes = {
  headers: PropTypes.object.isRequired,
  data: PropTypes.array.isRequired,
  primaryKey: PropTypes.string.isRequired
};
export default sematable('BiopsyPathoTable', BiopsyPatho, columns);
