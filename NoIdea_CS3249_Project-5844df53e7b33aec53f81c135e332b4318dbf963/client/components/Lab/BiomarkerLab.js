...
/**
 * Component for Biomarker Lab Table
 */
class BiomarkerLab extends Component {
  render() {
    return (
      <div>
 ...
 */
BiomarkerLab.propTypes = {
  headers: PropTypes.object.isRequired,
  data: PropTypes.array.isRequired,
  primaryKey: PropTypes.string.isRequired
};
export default sematable('BiomarkerLabTable', BiomarkerLab, columns);
